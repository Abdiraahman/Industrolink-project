      ...
      if (response) {
        ...
        if (user.role === 'lecturer' && response.lecturer_details) {
          ...
          if (response.recent_tasks) {
            details.recent_tasks = response.recent_tasks;
          }
                          ...
                          <div className="bg-blue-50 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-sm text-gray-900">{userDetails.department}</p>
                              </div>
                              <div>
                                <label className="text-sm font-medium text-gray-500">Title</label>
                                <p className="text-sm text-gray-900">{userDetails.title}</p>
                              </div>
                              <div>
                                <label className="text-sm font-medium text-gray-500">Created</label>
                          ...
                          <div className="bg-green-50 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-4">
                              <div>
                                ...
                                <p className="text-sm text-gray-900">{userDetails.registration_no}</p>
                              </div>
                              <div>
                                <label className="text-sm font-medium text-gray-500">Academic Year</label>
                                <p className="text-sm text-gray-900">{userDetails.academic_year}</p>
                              </div>
                              <div>
                                <label className="text-sm font-medium text-gray-500">Course</label>
                                <p className="text-sm text-gray-900">{userDetails.course}</p>
                              </div>
                              <div>
                                <label className="text-sm font-medium text-gray-500">Year of Study</label>
                                <p className="text-sm text-gray-900">{userDetails.year_of_study}</p>
                              </div>
                            </div>
                            ...
                            <div className="border-t border-green-200 pt-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="text-sm text-gray-900">{userDetails.company_name}</p>
                                </div>
                                <div>
                                  <label className="text-sm font-medium text-gray-500">Duration</label>
                                  <p className="text-sm text-gray-900">{userDetails.duration_in_weeks} weeks</p>
                                </div>
                                <div>
                                  <label className="text-sm font-medium text-gray-500">Start Date</label>
                                  <p className="text-sm text-gray-900">{formatDate(userDetails.start_date)}</p>
                                </div>
                                <div>
                                  <label className="text-sm font-medium text-gray-500">Completion Date</label>
                                  <p className="text-sm text-gray-900">{formatDate(userDetails.completion_date)}</p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="border-t border-green-200 pt-4 mt-4">
                              ...
                              <div className="space-y-2">
                                {userDetails.recent_tasks && userDetails.recent_tasks.length > 0 ? (
                                  userDetails.recent_tasks.map((task) => (
